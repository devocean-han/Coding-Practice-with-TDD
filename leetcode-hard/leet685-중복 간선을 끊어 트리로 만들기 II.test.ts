...
describe('Reduntant Connection II', () => {
	...
	// // 규칙 총정리: 
	// describe('"사이클"만 하나 형성된 경우: 사이클을 이루는 마지막 간선을 끊기', () => {
	// 	let edges: number[][];
	...
	// 	});
	// });
	// describe('"사이클"을 이루지 못하고 "두 부모" 관계만 형성한 경우: 두 부모 중 마지막 하나를 끊기', () => {
	// 	let edges: number[][];
	...
	// 	});
	// });
	describe('"사이클"도 이루고 "두 부모"도 됨: 두 부모 중 사이클을 이루는 공통 간선을 끊기', () => {
		let edges: number[][];
